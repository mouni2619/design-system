...
// import { DEFAULT_ACCORDION_VARIANT } from "@components/constants";
...
//   ...rest
// }) {
//   const panels = items.map(function (item) {
//     return { key: item.key, label: buildLabel(item.icon, item.title), children: item.content };
//   });
...
//   return <AntCollapse bordered accordion={accordion} expandIconPosition="end" items={panels} {...rest} />;
// }
